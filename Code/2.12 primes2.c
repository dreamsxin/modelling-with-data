//**primes is the pointer to the pointer for primes
// i.e the memory address of the primes pointer
// *primes then contains the address of this array
// which we can pass to realloc
#include <math.h>
#include <stdio.h>
#include <malloc.h>
