//gcc "4.2 state taxes.c" -std=gnu99 -lapophenia -lgsl -lsqlite3
//./a.out
...
int main(){
  ...
  Apop_col_tv(d, "income", income_vector); // take apop_data structure (d), get the income col
  // and use this to create a gsl_vector called income_vector 
  d->vector = apop_vector_map(income_vector, calc_taxes); // map calc_taxes function to each element
